        ...
        <div class="col-lg-7">
            ...
            <div class="card shadow-sm">
                <div class="card-header form-card-header">
                    <h5 class="mb-0 text-white"><i class="bi bi-person-plus-fill me-2"></i>Tambah Data Mahasiswa</h5>
                </div>
                <div class="card-body p-4">

                    <?php if (!empty($errors)): ?>
                        <div class="alert alert-danger">
                            <i class="bi bi-exclamation-triangle-fill me-2"></i><strong>Perbaiki kesalahan berikut:</strong>
                            <ul class="mb-0 mt-1">
